window.CITRUS_SOURCE_FILES = [
  ...
  },
  {
    ...
    "description": "Typer 命令入口，负责解析参数、读取配置、创建 provider 并调用 runtime。",
    "symbols": [
      "run",
      "providers",
      "config"
  ...
  },
  {
    ...
    "description": "权限模块入口，导出决策模型和默认分级策略。",
    "symbols": [],
  ...
  },
  {
    ...
    "description": "工具执行前的权限决策模型，表达 allow、ask 和 deny。",
    "symbols": [
      "PermissionDecision"
    ],
  ...
  },
  {
    ...
    "description": "OpenAI adapter，把内部消息和工具规范映射到 OpenAI chat completions。",
    "symbols": [
      "OpenAIProvider"
    ],
  ...
  },
  {
    ...
    "description": "核心 agent loop：组装 context、调用 provider、处理工具调用、记录事件并返回结果。",
    "symbols": [
      "RunRequest",
      "RunResult",
      "AgentRuntime"
  ...
  },
  {
    ...
    "description": "runtime 内部统一消息模型，隔离各 provider 的外部消息格式。",
    "symbols": [
      "ToolCall",
      "TextBlock",
      "ToolCallBlock",
