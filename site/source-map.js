window.CITRUS_SOURCE_FILES = [
  ...
  },
  {
    ...
    "description": "Typer 命令入口，负责解析参数、读取配置、创建 provider、接入权限审批、使用 Unicode 友好的 prompt 输入、运行一次性任务或持续 chat loop。",
    "symbols": [
      "_approve_permission",
      "_read_chat_input",
  ...
  },
  {
    ...
    "description": "Context 子包入口，导出 builder 和 deterministic compactor。",
    "symbols": [],
  ...
  },
  {
    ...
    "description": "组装每轮 active context，并在 provider 调用前委托 compactor 准备 messages。",
    "symbols": [
      "ContextBuilder"
    ],
  ...
  {
    "group": "context",
    "path": "src/citrus/context/compactor.py",
    "description": "Deterministic active context compactor，压缩旧 tool result 并 pair-safe 裁剪历史。",
    "symbols": [
      "ContextCompactor",
      "ContextCompactorConfig",
      "_Segment",
  ...
  },
  {
    ...
    "description": "测试与 demo provider，用预设响应或重复响应驱动 runtime、CLI run 和 CLI chat 的可重复验证。",
    "symbols": [
      "FakeProvider"
    ],
  ...
  },
  {
    ...
    "description": "核心 agent loop：组装 context、调用 provider、每次模型调用前压缩 active messages、处理工具调用并记录事件。",
    "symbols": [
      "RunRequest",
      "RunResult",
      "AgentRuntime"
